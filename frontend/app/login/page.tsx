    ...
    return (
        <main className="min-h-screen p-4 flex items-center justify-center font-sans">
            <div className="w-full max-w-md">
                <Spellbook title="Identify Yourself">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative group">
                            <div className="absolute -top-3 -right-2 bg-accent-gold text-black text-xs font-bold px-2 py-1 rounded shadow-md animate-bounce">
                                Recommended!
                            </div>
                            <button
                                ...
                                className={clsx(
                                    ...
                                    "border-2 border-[#5865F2] hover:border-white/20"
                                )}
                            >
                                <MessageCircle className="w-6 h-6" />
                                <div className="text-left">
                                    <div className="font-bold text-lg">Login with Discord</div>
                                    <div className="text-xs text-white/80">Enables direct DMs for Hatching</div>
                                </div>
                            </button>
                        </div>
                        ...
                        >
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-xs text-gray-500">Standard account access</div>
                            </div>
                        </button>
                    </div>
